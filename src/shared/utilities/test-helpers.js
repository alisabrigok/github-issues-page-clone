export const labels = [{ value: 554733913, label: 'issue: question', color: '009900' }];
export const authors = [{ value: 693791, label: 'emibcn', avatarUrl: 'https://avatars2.githubusercontent.com/u/693791?v=4' }];
